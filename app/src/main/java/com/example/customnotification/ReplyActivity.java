...
public class ReplyActivity extends AppCompatActivity {
    ...
    private static final String KEY_NOTIFY_ID = "key notify id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditReply = findViewById(R.id.edt_reply);
    ...
    private void sendMessage(int notifiyId, int messageId){
        updateNotification(notifiyId);
